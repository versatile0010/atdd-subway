...
public class FixtureData {
    ...
    public static CreateLineRequest 지하철_노선_생성_데이터_만들기(String name, String color, Long distance, Long downStationId, Long upStationId) {
        return new CreateLineRequest(color, distance, name, downStationId, upStationId);
    }

    public static ModifyLineRequest 지하철_노선_수정_데이터_만들기(String name, String color, Long distance, Long downStationId, Long upStationId) {
    ...
    public static void 이호선_강남역하행_서초역상행_생성하기() {
        ...
        지하철_역_생성하기(강남역);
        지하철_역_생성하기(서초역);
        CreateLineRequest 이호선 = new CreateLineRequest("green", 10L, "2호선", 1L, 2L);
        지하철_노선_생성하기(이호선);
    }
    ...
    public static Line createEmptyLine_이호선() {
        return Line.createMock(1L, "이호선", 10L, "green");
    }
}
